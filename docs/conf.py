...
# -*- coding: utf-8 -*-
#
# SPN documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'SPN.tex', 'SPN Documentation',
     'yguan', 'manual'),
]
...
man_pages = [
    (master_doc, 'spn', 'SPN Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'SPN', 'SPN Documentation',
     author, 'SPN', 'One line description of project.',
     'Miscellaneous'),
]
